        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 mb-0"><a href="#" class="text-black">Home</a> <span class="mx-2 mb-0">/</span> <a
                        href="cart.html" class="text-black" >Cart</a> <span class="mx-2 mb-0">/</span> <strong class="text-white">Checkout</strong>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="p-3 p-lg-5 border">
                                <form action="{{ route('user.order.simpan') }}" method="POST">
                                    ...
                                    <table class="table site-block-order-table mb-5">
                                        <h2 class="h3 mb-3 text-black font-weight-bold text-black text-center mb-4">Your
                                            Order</h2>
                                        <thead>
                                            <th>Product</th>
                                            <th>Total</th>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($keranjangs as $keranjang)
                                                <tr>
                                                    <td class="text-white">{{ $keranjang->nama_produk }} <strong class="mx-2">x</strong>
                                                        {{ $keranjang->qty }}</td>
                                                    <?php
                                                    $total = $keranjang->price * $keranjang->qty;
                                                    $subtotal = $subtotal + $total;
                                                    ?>
                                                    <td class="text-white">Rp. {{ number_format($total, 2, ',', '.') }}</td>
                                                </tr>
                                            @endforeach
                                            <tr>
                                                <td class="text-white">
                                            ...
                                            <tr>
                                                <td class="text-black">Alamat Penerima</td>
                                                <td class="text-black">{{ $alamat->detail }}, {{ $alamat->kota }}, {{ $alamat->prov }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <div class="form-group text-white">
                                        ...
                                        <small class="text-white">Jika memilih cod maka akan dikenakan biaya tambahan sebesar Rp. 10.000,00 dan
                                    ...
                                    <div class="form-group">
                                        <button class="btn btn-dark btn-lg py-3 btn-block" type="submit">Pesan
                                            Sekarang</button>
                                        <small class="text-white">Mohon periksa alamat penerima dengan benar agar tidak terjadi salah
                                            pengiriman</small>
                                    </div>
                                </form>
                            </div>
